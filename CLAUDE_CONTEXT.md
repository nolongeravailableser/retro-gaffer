...
- `npm test` — **217/217 passing** across 23 files. `npm run test:e2e` — Playwright
...
- **Daily leaderboard**: NOT built — needs the project's first backend
  (provisioning decision pending; see §3).
